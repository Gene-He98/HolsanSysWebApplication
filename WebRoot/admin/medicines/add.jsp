...
<body>
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/MedicineAddServlet" method="post">
		&nbsp;
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong><STRONG>添加药品</STRONG> </strong>
				</td>
			</tr>

			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">药物名称：</td>
				<td class="ta_01" bgColor="#ffffff">
				<input type="text" name="medicineName" class="bg" autocomplete="off" required="required"/>
				</td>
				<td align="center" bgColor="#f5fafe" class="ta_01">药品别名：</td>
				<td class="ta_01" bgColor="#ffffff">
				<input type="text" name="medicineAnotherName" class="bg" autocomplete="off"/>
				</td>
			</tr>
			...
			<TR>
				...
				<textarea
						...
						style="WIDTH: 50%" required="required"></textarea>
				</TD>
			</TR>
			<TR>
			...
			<TR>
				...
				<TD class="ta_01" bgColor="#ffffff" colSpan="3">
				<input type="text" name="validity" autocomplete="off" required="required" onfocus="WdatePicker({minDate:'%y-%M-{%d}'})"/>
				</TD>
			</TR>
			<TR>
